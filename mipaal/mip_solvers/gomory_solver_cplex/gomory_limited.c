...
int main(int argc, char* argv[]) {
    ...
    if(argc < 4){
      printf("only %d arguments, need input mip, output mip, and gomory number\n", argc);
      return 1;
    }
    ...
    int gomory_limit;
    gomory_limit = strtol(argv[3], NULL, 10);
    ...
    status = CPXsetintparam(env, CPXPARAM_MIP_Cuts_Gomory, gomory_limit);
